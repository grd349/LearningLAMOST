...
class Temperature_Regressor():
	def __init__(self, sfile):
		...
		features_df = pd.read_csv(sfile, sep=',')
		
		catalog_file = "../../dr1_stellar.csv"
	...
	def predict_temperatures(self, regr=RandomForestRegressor()):
		...
		X_train, X_test, y_train, self.y_test = train_test_split(self.features,self.temperatures,test_size=0.5)
...
if __name__ == "__main__":
	...
	spec_regr = Temperature_Regressor(sfile)
